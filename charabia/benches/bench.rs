...
static DATA_SET: &[((usize, Script, Language), &str)] = &[
    ...
    ((353, Script::Latin, Language::Deu), "Magdeburg, die Hauptstadt Sachsen-Anhalts, beeindruckt mit dem Magdeburger Dom, dem Jahrtausendturm im Elbauenpark und dem Wasserstraßenkreuz. Der Domplatz ist ein kulturelles Zentrum, umgeben von historischen Bauwerken. Die Elbauenparklandschaft bietet viele Freizeitmöglichkeiten, während die Magdeburger Börde für fruchtbare Ackerflächen bekannt ist."),
];
